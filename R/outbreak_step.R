...
#'
#' @param day number of days from start of the infection - must be > 0
...
#' @param delayfn function samples from the onset-to-hospitalization delay; generated by dist_setup
...
outbreak_step <- function(day, case_data, net = haslemere,
  ...
  if(isolation) {
    ...
    if(quarantine){
      ...
      # Randomly instantiate break-outs from resulting from quarantining
      new_quarantine_infections <- runif(1, 0, 10000)
    }
  ...
  # Introduce new infections from quarantining
  new_cases = new_cases + new_quarantine_infections
